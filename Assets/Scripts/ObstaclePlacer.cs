...
public class ObstaclePlacer : MonoBehaviour
{
    ...
    [SerializeField][Range(0, 10)] private float randomHorizontalDisplacement = 7;
    ...
    void PlaceObstacles()
    {
        ...
        _currentPosition + distance * movementDirection + displacement + new Vector3(0, Random.Range(0, randomVerticalDisplacement), Random.Range((randomHorizontalDisplacement * -1), randomHorizontalDisplacement)), prefab.transform.rotation, transform);
